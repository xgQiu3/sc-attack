...
from model_utils.simple_view_util import PCViews, Squeeze, BatchNormPoint


class get_model(nn.Module):
    def __init__(self, num_class, normal_channel=False, backbone='resnet18', feat_size=16):
    ...
    def get_img_layers(backbone, feat_size):
        ...
        from model_utils.resnet import _resnet, BasicBlock
